  ...
  public String getAllBooks()
  {
	 String s = "";
	  ...
	  for(int i = 0; i != base.length; i++)
	  {
		  if(base[i] != null)
		  {
		      if(base[i].getPersonKey() != null)
		      {
		    	  
		    	  s = s + "\nISBN: " + base[i].getKey().getNumberCode() +  "\nAuthor: " + base[i].getAuthor() + "\nTitle: " +  base[i].getTitle() + "\n Book ID: " + base[i].getPersonKey().getInt() + "\n Timeborrowed: " +base[i].getTimesBorrowed();
  
		      }
			  
			  
			  s = s +  "\nAuthor: " + base[i].getAuthor() + "\nTitle: " +  base[i].getTitle() + "\n Book ID: " + base[i].getKey().getNumberCode()  + "\n Book time borrowed: "+ base[i].getTimesBorrowed()  + "\n\n"  ;
